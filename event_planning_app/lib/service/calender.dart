  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(child: ListView(
        children: [
          DrawerHeader(
            decoration: BoxDecoration(color: Color.fromARGB(255, 121, 85, 72)),
            child: Column(),
            ),
            ListTile(
              onTap: (){
            ...
            ListTile(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => WeekCalender()),);
              },
            ...
            ListTile(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => MonthCalender()),);
              },
